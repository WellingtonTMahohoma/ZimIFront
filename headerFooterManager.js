class SpecialHeader extends HTMLElement {
    connectedCallback() {
        ...
        // Bind menu toggle immediately after rendering
        this._initMenu();
    }
    ...
    _initMenu() {
        ...
        // Avatar previews
        const signupInput = this.querySelector('#avatarInputSignup');
        const loginInput  = this.querySelector('#avatarInputLogin');
...
function signupUser() {
    ...
    const user = { name, email, country, image: preview.dataset.src || '' };
...
function loginUser() {
    ...
    const user = { name, email, image: preview.dataset.src || '' };
    localStorage.setItem('zimfront_user', JSON.stringify(user));
    window.location.href = 'index.html';
}
